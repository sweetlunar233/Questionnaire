...
<template>
    <el-card class="page-container">
        <div class="header">
            ...
            <div class="extra">
                <el-button type="primary" @click="showCreateDialog" style="background-color: #17ec81;border: 0;">创建问卷</el-button>
            </div>
        </div>
        <!-- 搜索表单 -->
        <el-form inline class="searchform">
            ...
            <el-form-item>
                <el-button type="primary" class="searchbutton" @click="initCreated(username)" style="background-color: #17ec81;border: 0;">搜索</el-button>
                ...
                <div class="bg">
                    <div>
                        ...
                        <div class="card-footer">
                            ...
                            <el-switch v-model="questionnaire.IsOpening" style="float: right; margin-left: 10px" @change="updateIsOpening(questionnaire.SurveyID)"  class="deletebutton"/>
